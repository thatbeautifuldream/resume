      ...
      proofLinks: [
        {
          type: "source",
          label: "API Docs",
          url: "https://api.expense.milind.fyi/docs",
        },
        {
          type: "live",
          label: "Website",
          url: "https://expense.milind.fyi",
        },
      ],
      challenges: [
        "Keeping identity coherent across REST sessions, Telegram link codes, and MCP API keys without ever trusting client-supplied user IDs",
        "Designing a single ledger schema flexible enough for expenses, income, and savings while keeping queries fast and FX conversion accurate",
        "Making a Next.js PWA behave correctly on iOS Safari, including same-origin proxying, edge handling, and header overlap fixes for installed PWAs",
      ],
      url: "github.com/thatbeautifuldream/expense-agent-monorepo",
      keywords: [
        "TypeScript",
        "Next.js",
        "Express",
